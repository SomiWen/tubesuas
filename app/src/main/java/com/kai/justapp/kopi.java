...
//    }
    ...
    public void submitOrder(View view) {
        ...
        EditText isi = (EditText) findViewById(R.id.isi_feed);
        String name = nameField.getText().toString();
        String isi_feed = isi.getText().toString();
...
//        String priceMessage = createOrderSummary(name, price, hasWhippedCream, hasChocolateTopping);
        ...
        intent.putExtra(Intent.EXTRA_SUBJECT, "Feedback untuk aplikasi dari " +name);
        intent.putExtra(Intent.EXTRA_TEXT, isi_feed);
